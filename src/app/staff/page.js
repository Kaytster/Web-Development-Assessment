...
export default function Staff() {
    return (
      <div>
        ...
        <h3>News</h3>
        <p>Cantor College recently hosted the Software Engineering student of the year awards. </p>
        <p>  Short-listed candidates from around the country attended the one day event.</p>
        ...
        <p>The ISS team delivers the College's computing facilities including all hardware and software. </p>
        <p> They also run the staff helpdesk.</p>
